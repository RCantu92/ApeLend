...
// address
contract ApeLendNft is IERC721, ERC721, IERC721Receiver, ERC721Holder {
    ...
    // of a NFT by tokenId
    function ownerOf(uint _tokenId) public view override(ERC721, IERC721) returns (address) {
    ...
    */
    ...
    /*
    FIGURE OUT HOW TO CALL PUBLIC VARIABLES WITH
    ETHERS RATHER THAN HAVING A GETTER FUNCTION

    // Getter function for NFT collection name
    // DELETE, FIND WAY FOR ETHERS TO FUNCTION WITH
